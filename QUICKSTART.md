...
Step 4 — Install Cursor + the Claude Code extension
...
Give me the prompt below to copy-paste into Cursor's Claude Code panel (NOT here in the browser). Tell me to switch to Cursor and paste it there. Wish me well — the walkthrough takes over from there and creates the GitHub / Vercel / Supabase accounts I need, then builds my first real app.

---PASTE THIS INTO CURSOR'S CLAUDE PANEL---
Please clone https://github.com/moth-flame/vibe-coding-onboarding into a folder on my computer. Then open the SKILL.md file inside it and follow it step by step — it's an interactive walkthrough that sets me up for AI-assisted work at Moth+Flame. Also copy the cloned folder into ~/.claude/skills/vibe-coding-onboarding so I can re-run it later by typing /vibe-coding-onboarding. Start the walkthrough now.
---
```
